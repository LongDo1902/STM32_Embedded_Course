...
void buttonInit(char buttonPin, GPIO_PortName_t portName){
	...
	writePin(buttonPin, portName, MODER, INPUT_MODE); //Set buttonPin of portName as an input mode
	writePin(buttonPin, portName, PUPDR, PULL_DOWN); //Set buttonPin of portName as pull-down config
}
